...
our %EXPORT_TAGS = (
    ...
    WINSOCK => [qw(
	WSAEPFNOSUPPORT WSAEINVAL WSAECONNABORTED WSAEPROTOTYPE WSAEALREADY
	WSAEREMOTE WSAEDESTADDRREQ WSAEMFILE WSAENOPROTOOPT
	WSAEPROVIDERFAILEDINIT WSAELOOP WSAEADDRNOTAVAIL WSAESHUTDOWN
	WSAEISCONN WSAEDQUOT WSAENOMORE WSAEFAULT WSAENOTSOCK
	WSAEINVALIDPROVIDER WSAECONNRESET WSAEDISCON WSAEHOSTUNREACH
	WSAENOTEMPTY WSAEINVALIDPROCTABLE WSAEINPROGRESS WSAETIMEDOUT
	WSAETOOMANYREFS WSAECANCELLED WSAENETDOWN WSAEAFNOSUPPORT WSAEREFUSED
	WSAECONNREFUSED WSAEMSGSIZE WSAEWOULDBLOCK WSAENOTCONN WSAENOBUFS
	WSAENETRESET WSAEBADF WSAEPROCLIM WSAEPROTONOSUPPORT WSAENAMETOOLONG
	WSAEADDRINUSE WSAESOCKTNOSUPPORT WSAEINTR WSAESTALE WSAEUSERS
	WSAENETUNREACH WSAEHOSTDOWN WSAEACCES WSAEOPNOTSUPP
    )],
);
