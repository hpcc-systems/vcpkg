...
if(VCPKG_TARGET_IS_LINUX AND VCPKG_TARGET_ARCHITECTURE STREQUAL "arm64")
    # The bundled config.sub is too old to recognize all modern aliases.
    # Pass an explicit canonical alias that this tarball accepts.
    set(ARM_FLAG "--build=aarch64-unknown-linux")
elseif(VCPKG_TARGET_IS_WINDOWS AND VCPKG_TARGET_ARCHITECTURE STREQUAL "arm64")
    set(ARM_FLAG "--build=arm64-unknown-mingw32")
endif()
